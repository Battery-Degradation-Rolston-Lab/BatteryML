...
class SeversonFeatureExtractor(BaseFeatureExtractor):
    ...
    def get_features(self,
        ...
        if len(self.critical_cycles) < 3:
            raise ValueError("Critical cycles list does not have enough elements.")

        # print(len(self.critical_cycles))
        # print(f"self.critical_cycles: {self.critical_cycles}")
        # print(cell_data, cell_data.cycle_data)
